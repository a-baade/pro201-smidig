            ...
            <div className={"donate-page-content"}>
                ...
                <div className={"donate-text-div"}>
                    ...
                    <div className={"information-icon"}>?
                        <div className={"information-box"}>Choose how often you would like to donate selected amount to this charity. You can change amount and frequency at any time.</div>
                    </div>
                </div>

                <div className={"donate-form-frequency"}>
                    <div>
                        <input type={"radio"} id={"monthly"} name={"donation-frequency"} value={"monthly"}/>
                        <label htmlFor={"monthly"}>Monthly</label>
                    </div>
                    <div>
                        <input type={"radio"} id={"quarterly"} name={"donation-frequency"} value={"quarterly"}/>
                        <label htmlFor={"quarterly"}>Quarterly</label>
                    </div>
                    <div>
                        <input type={"radio"} id={"semiannually"} name={"donation-frequency"} value={"semiannually"}/>
                        <label htmlFor={"semiannually"}>Semiannually</label>
                    </div>
                    <div>
                        <input type={"radio"} id={"annually"} name={"donation-frequency"} value={"annually"}/>
                        <label htmlFor={"annually"}>Annually</label>
                    </div>
                </div>
                <p className={"donate-text-button"}>Donate $ XXXX to {name} every XX month(s)</p>
                <div>
                    <button className={"donate-page-button"}>Donate with Debit or Credit Card</button>
                </div>
            </div>
        </div>
    );
