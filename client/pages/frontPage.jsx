      ...
      <div className={"category-container"}>
        <div className={"nature"}>
          ...
          <p>
            ...
            faucibus. Sed tortor nisi, luctus a ullamcorper in, ultricies non
            erat. Cras arcu lorem, venenatis vitae pulvinar vel, consectetur sed
            ex.
          </p>
        </div>
        ...
        <div className={"newsfeed-child"}>
          <div className={"newsfeed-item"}>
            ...
            <p>
              ...
              will help stabalise the everyday life of the children and that
          ...
          <div className={"newsfeed-item"}>
            ...
            <p>
              ...
              illegally. Protecting nature is our responsibilty, and make sure
              that the next generation can enjoy wildnerness like us.
            </p>
            <p className={"read-more-btn"}>Read more</p>
          </div>
          <div className={"newsfeed-item"}>
